...
var Project = function () {
	...
	var projectDir;
	var assetsPatterns = ['*/src/main/@(resources|webapp)/**/*.@(js|html|css)'];
	var translationFilesPatterns = ['*/src/main/@(resources|webapp)/translations/*.properties'];
	var uiFilesPatterns = ['*/src/main/@(resources|webapp)/*.@(jsfiles|modules)'];
